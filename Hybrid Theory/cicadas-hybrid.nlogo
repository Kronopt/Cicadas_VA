...
@#$#@#$#@
<experiments>
  <experiment name="Test world size" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    ...
    <steppedValueSet variable="world-width" first="31" step="10" last="101"/>
    <steppedValueSet variable="world-height" first="31" step="10" last="101"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
